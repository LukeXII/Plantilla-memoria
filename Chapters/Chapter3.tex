...
%\begin{figure}[H]
%\centering
%\includegraphics[width=0.5\textwidth]{./Figures/arqFW.png}
...
En la figura \ref{fig:diagFSM} se puede ver un diagrama de transiciones simplificado de la máquina de estados implementada 
